...
// Test series skeleton shown while data is loading.
class StudentTestSeriesSkeleton extends StatelessWidget {
  const StudentTestSeriesSkeleton({super.key});
        ...
        slivers: [
                  ...
                  Positioned(
                    ...
                    child: Column(
                      ...
                      children: const [
                        ...
                        SizedBox(height: 6),
                        _SkeletonLine(width: 200, height: 22, radius: 10),
                        SizedBox(height: 6),
          ...
          SliverToBoxAdapter(
            child: Padding(
              ...
              child: const _SkeletonLine(width: 170, height: 12, radius: 6),
            ),
          ),
          SliverToBoxAdapter(
            child: Padding(
...
class _SkeletonSeriesCard extends StatelessWidget {
  const _SkeletonSeriesCard();
            ...
            child: Column(
              ...
              children: [
                Row(
                  crossAxisAlignment: CrossAxisAlignment.start,
                  children: [
                    _SkeletonLine(width: 48, height: 48, radius: 14),
                    SizedBox(width: 12),
                    Expanded(
                      child: Column(
                        crossAxisAlignment: CrossAxisAlignment.start,
                        children: [
                          ...
                          SizedBox(height: 6),
                          _SkeletonLine(width: 140, height: 10, radius: 6),
                        ],
                      ),
                    ),
                    SizedBox(width: 8),
                    _SkeletonLine(width: 32, height: 32, radius: 10),
                  ],
                ),
                SizedBox(height: 12),
                Row(
                  children: [
                    _SkeletonLine(width: 90, height: 12, radius: 6),
                    SizedBox(width: 12),
                    _SkeletonLine(width: 80, height: 12, radius: 6),
                  ],
                ),
              ],
            ),
