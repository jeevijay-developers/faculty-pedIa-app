...
export const sendPayoutInvoiceEmail = async ({
  to,
  payout,
  educator,
  pdfBuffer,
        ...
        <div style="background: #f8f9fa; border-radius: 8px; padding: 20px; margin: 25px 0;">
          <table style="width: 100%; border-collapse: collapse;">
            <tr>
              ...
              <td style="color: #333; font-weight: bold; padding: 8px 0; border-bottom: 1px solid #e0e0e0; text-align: right;">${
                payout?.payoutCheckId || payout?._id || "N/A"
              }</td>
            </tr>
            <tr>
  ...
  const html = `
    <div style="font-family: 'Segoe UI', Tahoma, Geneva, Verdana, sans-serif; max-width: 600px; margin: 0 auto; padding: 20px;">
      ...
      <div style="background: #ffffff; padding: 30px; border: 1px solid #e0e0e0; border-top: none; border-radius: 0 0 10px 10px;">
        <h2 style="color: #333; margin-top: 0;">Hi ${educator?.fullName || "Educator"},</h2>
        <p style="color: #555; font-size: 16px; line-height: 1.6;">
          This is a security notification to inform you that your bank account details for payouts were updated on <strong>${
        ...
        <div style="background: #fff3f3; border: 1px solid #ffcdd2; border-radius: 8px; padding: 20px; margin: 25px 0;">
          <table style="width: 100%; border-collapse: collapse;">
            <tr>
              ...
              <td style="color: #333; font-weight: bold; padding: 8px 0; text-align: right;">${
                educator?.bankDetails?.accountHolderName || "N/A"
              }</td>
            </tr>
            <tr>
              <td style="color: #666; padding: 8px 0;">Bank:</td>
              <td style="color: #333; font-weight: bold; padding: 8px 0; text-align: right;">${
                educator?.bankDetails?.bankName || "N/A"
              }</td>
            </tr>
            <tr>
